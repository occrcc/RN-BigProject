        ...
        return (
            <View style={styles.listItem}>
                ...
                <View style={[styles.listInfo, {borderTopWidth: !first ? 1 : 0}]}>
                    <View style={{flex: 1}}><Text style={[{color:'rgb(111,111,111)', fontSize:icon ? 13 : 17 }]}>{name}</Text></View>
                    <View style={styles.listInfoRight}>
                        ...
                        {disable ? null : (
                            <Font.Ionicons style={{marginLeft: 10}} name="ios-arrow-forward-outline" size={px2dp(18)}
                                           color="#bbb"/>)}
                    </View>
                </View>
            </View>
